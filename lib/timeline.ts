...
/**
 * The shape of a timeline, and nothing that talks to a model or a database.
 *
 * Same split as lib/briefing.ts and lib/faq.ts: the reader renders the
 * entries in the browser and must not drag the AI SDK into the bundle.
 */
