...
} from '@/features/artifacts/briefing'
import { defaultModel } from '@/lib/model'
import { maxPromptCharacters, maxScriptCharacters } from '@/lib/config'
import { inReadingOrder, windowPassages } from '@/features/chat/context'
import { getDb, type Database } from '@/lib/db'
import { Faq, faqRules, mergeFaqs, type Faq as FaqType } from '@/features/artifacts/faq'
import {
  Flashcards,
  flashcardsRules,
  mergeFlashcards,
