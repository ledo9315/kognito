...
/**
 * The shape of an audio overview, plus the cutting and joining of its script,
 * which the writing and the speaking both need. The player runs in the
 * browser and needs nothing beyond this file. See artifact-kinds.ts.
 */
