...
import { AudioPlayer } from '@/features/artifacts/components/audio-player'
import {
  useClosingReader,
  useNotebookStore,
...
import { readBriefing, type Briefing } from '@/features/artifacts/briefing'
import { readFaq, type Faq } from '@/features/artifacts/faq'
import { readFlashcards, type Flashcards } from '@/features/artifacts/flashcards'
import { readTimeline, type Timeline } from '@/features/artifacts/timeline'
...
function Body({ artifact }: { artifact: ArtifactRow }) {
  switch (artifact.kind) {
    ...
    // the studio instead, see studio-panel.tsx. Listed here so the
